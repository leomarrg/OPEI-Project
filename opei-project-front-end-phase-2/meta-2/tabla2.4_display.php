...
<html lang="en">
  <head>
    ...
    <title>UPRA Reports Tabla 2-4 Editar</title>
...
<body>
        ...
        <header>
            ...
            <h2 class="tablaheader"> Editar Informaci&oacute;n en la Tabla 2.4</h2>
        </header>
    ...
    <div class="formbold-form-wrapper-edit">
        ...
        <table class="table">
          ...
          <tbody>
            ...
            $sql = "SELECT * FROM table24 WHERE DepartmentID = ? AND year = ?";
            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<td style='display: none;'>" . $row['table24ID'] . "</td>";
                ...
                echo "<td><a class='delete-btn' href='../meta-2/tabla2.4_delete.php?id=" . $row['table24ID'] . "'>Borrar</a></td>";
                echo "</tr>";
            }
            // Close connection
            $conn->close();
          ...
          <a class="underline-button" href="tabla2.4.php">Volver</a>
      </div>
    </div>
  </div>
