...
<html lang="en">
  <head>
    ...
    <title>UPRA Reports Tabla 3-1 Editar</title>
...
<body>
        <header>
            ...
            <h2 class="tablaheader">Tabla 3.1: Reconocimientos estudiantiles por departamento</h2>
            <h2 class="tablaheader"> Editar Informaci&oacute;n en la Tabla 3.1</h2>
        </header>
    ...
    <div class="formbold-form-wrapper-edit">
        <table class="table">
          ...
          <tbody>
            ...
            $sql = "SELECT * FROM table31 WHERE DepartmentID = ? AND year = ?";
            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<td style='display: none;'>" . $row['table31ID'] . "</td>";
                ...
                echo "<td><a class='delete-btn' href='../meta-3/tabla3.1_delete.php?id=" . $row['table31ID'] . "'>Borrar</a></td>";
                echo "</tr>";
            }
            // Close connection
            $conn->close();
        ?>
          ...
          <a class="underline-button" href="tabla3.1.php">Volver</a>
      </div>
    </div>
  </div>
