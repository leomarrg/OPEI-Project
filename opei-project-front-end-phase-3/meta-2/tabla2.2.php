...
<html lang="en">
    <head>
        ...
        <title>UPRA Reports Tabla 2-2</title>
    </head>
<body>
        <header>
...
<div class="formbold-main-wrapper">
    <div class="formbold-form-wrapper">
      <form  id="myForm2_2">
      <h4 class="header1"> Llenar Informaci&oacute;n<br>  <br> Tabla 2.2: Convenios y Alianzas</h4>
        ...
        <div class="formbold-input-flex">
          <div>
            ...
            />
            <label for="titConvenio1" class="formbold-form-label">Título del convenio o alianza *</label>
          </div>
          <div>
            <input
              type="text"
              ...
              class="formbold-form-input"
            />
            <label for="agency" class="formbold-form-label">Agencia o institución</label>
          </div>
        </div>
        ...
        <a class="underline-button" href="../meta-2/tabla2.2_display.php">Editar</a>
      </form>
    </div>
  </div>
