...
<div class="formbold-main-wrapper-edit">
    ...
    <h4 class="header1">Editar Informaci&oacute;n<br>  <br>Tabla 2.5: Otros logros alcanzados por Objetivo y Actividad en la Meta 2</h4>
        ...
        <table class="table">
            ...
            $sql = "SELECT * FROM table25 WHERE DepartmentID = ? AND year = ?";
