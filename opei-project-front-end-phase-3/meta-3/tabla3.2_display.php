...
<div class="formbold-main-wrapper-edit">
    ...
    <h4 class="header1">Editar Informaci&oacute;n<br>  <br>Tabla 3.2: Actividades departamentales para <br> promover el vínculo afectivo con la Institución</h4>
        ...
        <table class="table">
            ...
            $sql = "SELECT * FROM table32a WHERE DepartmentID = ? AND year = ?";
