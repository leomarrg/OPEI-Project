...
<html lang="en">
  <head>
    ...
    <title>UPRA Reports Tabla 3-3 Editar</title>
...
<body>
        <header>
            ...
            <h2 class="tablaheader"> Editar Informaci&oacute;n en la Tabla 3.3</h2>
        </header>
...
<div class="formbold-main-wrapper-edit">
  ...
  <h4 class="header1">Editar Informaci&oacute;n<br>  <br>Tabla 3.3: Otros logros alcanzados por Objetivo y Actividad en la Meta 3</h4>
      ...
      <table class="table">
        ...
        <tbody>
          ...
          $sql = "SELECT * FROM table33 WHERE DepartmentID = ? AND year = ?";
          ...
          while ($row = $result->fetch_assoc()) {
              echo "<tr>";
              echo "<td style='display: none;'>" . $row['table33ID'] . "</td>";
              ...
              echo "<td><a class='delete-btn' href='../meta-3/tabla3.3_delete.php?id=" . $row['table33ID'] . "'>Borrar</a></td>";
              echo "</tr>";
      ...
      ?>
          ...
          <a class="underline-button" href="../meta-3/tabla3.3.php">Volver</a>
      </div>
  </div>
</div>
