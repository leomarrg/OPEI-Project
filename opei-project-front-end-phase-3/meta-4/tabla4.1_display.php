...
<html lang="en">
  <head>
    ...
    <title>UPRA Reports Tabla 4-1</title>
...
<body>
        <header>
            ...
            <h2 class="tablaheader">Tabla 4.1: Actividades dirigidas a la comunidad externa</h2>
            <h2 class="tablaheader"> Editar Informaci&oacute;n en la Tabla 4.1</h2>
        </header>

<!-- Main form -->
<div class="formbold-main-wrapper-edit">
    <div class="formbold-form-wrapper-edit">
    <h4 class="header1">Editar Informaci&oacute;n<br>  <br>Tabla 4.1: Actividades dirigidas a la comunidad externa</h4>
      ...
      <form id="myForm4_1">
        ...
        <table class="table">
          ...
          <tbody>
            ...
            $sql = "SELECT * FROM table41 WHERE DepartmentID = ? AND year = ?";
        ...
        ?>
          ...
          <a class="underline-button" href="../meta-4/tabla4.1.php">Volver</a>
      </div>
