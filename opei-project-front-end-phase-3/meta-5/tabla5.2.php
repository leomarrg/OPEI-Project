...
<html lang="en">
    <head>
        ...
        <title>UPRA Reports Tabla 5-2</title>
    </head>
<body>
        <header> 
...
<div class="formbold-main-wrapper">
    <div class="formbold-form-wrapper">
      <form id="myForm5_2">
      <h4 class="header1"> Llenar Informaci&oacute;n<br>  <br>Tabla 5.2: Iniciativas para recaudación de fondos de su departamento</h4>
        ...
        <div class="formbold-input-flex">
            ...
            <div>
                <input
                    ...
                    class="formbold-form-input"
                />
                <label for="fondoRecad" class="formbold-form-label">Fondos recaudados</label>
            </div>
        ...
        <a class="underline-button" href="tabla5.2_display.php">Editar</a>
      </form>
    </div>
  </div>
