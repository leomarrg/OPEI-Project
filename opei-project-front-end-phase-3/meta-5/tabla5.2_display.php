...
<div class="formbold-main-wrapper-edit">
    ...
    <h4 class="header1">Editar Informaci&oacute;n<br>  <br>Tabla 5.2: Iniciativas para recaudación de fondos de su departamento</h4>
        ...
        <table class="table">
            ...
            <tbody>
              ...
              $sql = "SELECT * FROM table52 WHERE DepartmentID = ? AND year = ?";
