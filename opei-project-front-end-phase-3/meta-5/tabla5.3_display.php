...
<head>
    ...
    <title>UPRA Reports Tabla 5-3 Editar</title>
...
<div class="formbold-main-wrapper-edit">
    ...
    <h4 class="header1">Editar Informaci&oacute;n<br>  <br>Tabla 5.3: Total de proyectos en innovación y emprendimiento</h4>
        ...
        <table class="table">
            ...
            <?php
              ...
              $sql = "SELECT * FROM table53 WHERE DepartmentID = ? AND year = ?";
              ...
              while ($row = $result->fetch_assoc()) {
                  echo "<tr>";
                  echo "<td style='display: none;'>" . $row['table53ID'] . "</td>";
                  ...
                  echo "<td><a class='delete-btn' href='../meta-5/tabla5.3_delete.php?id=" . $row['table53ID'] . "'>Borrar</a></td>";
                  echo "</tr>";
              }
              // Close connection
              $conn->close();
          ?>
            ...
            <a class="underline-button" href="tabla5.3.php">Volver</a>
        </div>
    </div>
  </div>    
