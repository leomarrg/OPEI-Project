            ...
            <form  id="myForm1_1">
                ...
                <div class="formbold-input-flex">
                    <div>
                        ...
                        />
                        <label for="Cursos" class="formbold-form-label"> Curso </label>
                    </div>                
                    <!--Accion de curso dropdown list-->
                </div>
                <div class="hide">***Formato de cursos CCOM5006. No espacios</div>
                ...
                <div class="formbold-input-flex">
                    ...
                    <div>
                        ...
                        <label for="accDeCurso" class="formbold-form-label">Acciones de Curso</label>
                    </div>
                </div>
                ...
                <div class="formbold-input-flex">
                    <div>
                        ...
                        <label for="estatus" class="formbold-form-label">Estatus</label>
                    </div>
                </div>
                ...
                <div class="formbold-input-flex">
                    ...
                    <textarea
                        ...
                        class="formbold-form-input"
                    ></textarea>
                    <label for="breveDescrip" class="formbold-form-label">Breve descripción </label>
                </div>
            </div>
                ...
                <a class="underline-button" href="../meta-1/tabla1.1_display.php">Editar</a>    
            </form>
        </div> 
