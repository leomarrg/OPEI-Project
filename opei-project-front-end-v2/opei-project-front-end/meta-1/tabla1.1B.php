        ...
        <h4 class="header1"> Llenar Informaci&oacute;n<br>  <br> Tabla 1.1B: Cursos en diversas modalidades educativas</h4>
            ...
            <div class="formbold-input-flex">
                <div>
                    ...
                    />
                    <label for="cambAcademico" class="formbold-form-label">Cambio académico  </label>
                </div>
            </div>

            <!-- Cambio academico menor input text -->
            <div class="formbold-input-flex">
                <div>
                    <input
                        type="text"
                        name="cambAcademicoMenor"
                        id="cambAcademicoMenor"
                        placeholder="Escriba texto..."
                        class="formbold-form-input"
                    />
                    <label for="cambAcademicoMenor" class="formbold-form-label">Cambio adacémico institucional o menor </label>
                </div>
            </div>
            <!-- Cambio academico Significativo input text -->
            <div class="formbold-input-flex">
                <div>
                    <input
                        type="text"
                        name="cambAcademicoSig"
                        id="cambAcademicoSig"
                        placeholder="Escriba texto..."
                        class="formbold-form-input"
                    />
                    <label for="cambAcademicoSig" class="formbold-form-label">Cambio académico significativo </label>
                </div>
            </div>

            <!-- Cambio academico Sustancial input text -->
            <div class="formbold-input-flex">
                <div>
                    <input
                        type="text"
                        name="cambAcademicoSus"
                        id="cambAcademicoSus"
                        placeholder="Escriba texto..."
                        class="formbold-form-input"
                    />
                    <label for="cambAcademicoSus" class="formbold-form-label">Cambio sustancial </label>
                </div>
            </div>
            ...
            <button class="formbold-btn">
                ...
                <a class="underline-button" href = "../meta-1/tabla1.1B_display.php">Editar</a>
