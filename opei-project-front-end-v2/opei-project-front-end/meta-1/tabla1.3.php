...
<html lang="en">
    <head>
        ...
        <title>UPRA Reports Tabla 1-3</title>
    </head>
<body>
    <header>
...
<div class="formbold-main-wrapper">
    <div class="formbold-form-wrapper">
        ...
        <form id="myForm1_3">
        <h4 class="header1">Llenar Informaci&oacute;n<br>  <br>Tabla 1.3: Programas acreditados</h4>
         ...
         <!-- Nombre del programa académico acreditado input text -->
            <div class="formbold-input-flex">
                <div>
                    <input
                        type="text"
                        name="nombreProgAcredit"
                        id="nombreProgAcredit"
                        placeholder="Escriba texto..."
                        class="formbold-form-input"
                    />
                    <label for="nombreProgAcredit" class="formbold-form-label">Nombre del programa académico acreditado</label>
                </div>
                <div>
                    <input
                        type="text"
                        name="agenciaAcreditProg"
                        id="agenciaAcreditProg"
                        placeholder="Escriba texto..."
                        class="formbold-form-input"
                    />
                    <label for="agenciaAcreditProg" class="formbold-form-label">Agencia que acredita el Programa</label>
                </div>
            ...
            <div class="formbold-input-flex">
                <div>
                    <input
                        type="text"
                        name="lastYearAcredit"
                        id="lastYearAcredit"
                        placeholder="Escriba texto..."
                        class="formbold-form-input"
                    />
                    <label for="lastYearAcredit" class="formbold-form-label">Año de última acreditación</label>
                </div>
                <div>
                    <input
                        type="text"
                        name="nextYearAcredit"
                        id="nextYearAcredit"
                        placeholder="Escriba texto..."
                        class="formbold-form-input"
                    />
                    <label for="nextYearAcredit" class="formbold-form-label">Año próxima acreditación</label>
                </div>
            ...
            <div class="formbold-input-flex">
                <div>
                    ...
                    <label for="numProgAcredit" class="formbold-form-label">Número de programas acreditados </label>
                </div>
                <div>
                    <input
                        type="text"
                        ...
                        class="formbold-form-input"
                    />
                    <label for="recomendaciones" class="formbold-form-label">Recomendaciones</label>
                </div>
            ...
            <a class="underline-button" href="../meta-1/tabla1.3_display.php">Editar</a>    
        </form>
