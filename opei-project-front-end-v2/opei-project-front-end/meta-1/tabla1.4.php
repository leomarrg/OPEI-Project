        ...
        <h4 class="header1"> Llenar Informaci&oacute;n<br>  <br>Tabla 1.4 A: Estrategias de avalúo del aprendizaje</h4>
            ...
            <div class="formbold-input-flex">
                <div>
                    ...
                    />
                    <label for="cursoTabla1-4" class="formbold-form-label">Curso</label>
                    </div>
                    <div>
                        <input
                            type="text"
                            ...
                            class="formbold-form-input"
                        />
                        <label for="stratEval" class="formbold-form-label">Estrategía avalúo</label>
                </div>
            ...
            <div class="formbold-input-flex">
                <div>
                    <input
                        ...
                        class="formbold-form-input"
                    />
                    <label for="indicadores" class="formbold-form-label">Indicadores</label>
                </div>
                <div>
                    <input
                        type="text"
            ...
            <a class="underline-button" href="../meta-1/tabla1.4_display.php">Editar</a>
        <!-- Closing form tag -->
        </form>
