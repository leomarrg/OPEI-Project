          ...
          <tbody>
            <tr>
              ...
              while ($row = $result->fetch_assoc()) {
                  ...
                  echo "<td><input type='text' id='field1_" . $row['table23ID'] . "' value='" . $row['field1'] . "'></td>";
                  echo "<td><input type='text' id='field2_" . $row['table23ID'] . "' value='" . $row['field2'] . "'></td>";
                  echo "<td><input type='text' id='field3_" . $row['table23ID'] . "' value='" . $row['field3'] . "'></td>";
                  echo "<td><input type='text' id='field4_" . $row['table23ID'] . "' value='" . $row['field4'] . "'></td>";
                  echo "<td><a href='javascript:void(0);' onclick='updateTable23Row(" . $row['table23ID'] . ")'>Update</a></td>";
                  echo "<td><a href='delete.php?id=" . $row['table23ID'] . "'>Borrar</a></td>";
                  echo "</tr>";
              }
              // Close connection
              $conn->close();
