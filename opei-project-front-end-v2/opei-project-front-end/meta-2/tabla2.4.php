...
<html lang="en">
    <head>
        ...
        <title>UPRA Reports Tabla 2-4</title>
    </head>
<body>
        <header>
            <h1 class="uprareports">UPRA Reports</h1>
            <h2 class="bienvenidosusuario"><?php echo $department['DepartmentName'] ?></h2>
            <h2 class="tablaheader">Tabla 2.4: Proyectos estudiantiles de investigación y creación</h2>
            <h2 class="tablaheader"> Llenar Informaci&oacute;n en la Tabla 2.4</h2>
        </header>
      ...
      <form id="myForm2_4">
        ...
        <div class="formbold-input-flex">
          <div>
            ...
            />
            <label for="titInve" class="formbold-form-label">Título del trabajo de investigación o creación 
            </label>
          </div>
          <div>
            <select 
          ...
          <!-- Breve descripcion -->
            ...
            <div>
              <input
                ...
                class="formbold-form-input"
              />
              <label for="profe" class="formbold-form-label">Profesor (mentor o supervisor)</label>
            </div>
            <div>
              <input
                type="text"
                ...
                class="formbold-form-input"
              />
              <label for="numEst" class="formbold-form-label">Número de estudiantes investigadores por proyecto</label>
            </div>
        </div>
        <!-- Submit button -->
        <button class="formbold-btn">Submit</button>
        <a class="underline-button" href="tabla2.4_display.php">Editar</a>
      </form>
    </div>
  </div>
