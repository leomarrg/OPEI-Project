...
<div class="formbold-main-wrapper">
  <div class="formbold-form-wrapper">
      ...
      <form id="myForm2_5">
      <h4 class="header1"> Llenar Informaci&oacute;n<br>  <br> Tabla 2.5: Otros logros alcanzados por Objetivo y Actividad en la Meta 2</h4>
      ...
      <div class="formbold-input-flex">
          <div>
              ...
              />
              <label for="obj21" class="formbold-form-label">2.1 Desarrollar y apoyar la divulgación de investigaciones científicas y de creación en conferencias, foros, revistas arbitradas y publicaciones aplicables.</label>
          </div>
          <div>
              <input
                  type="text"
                  ...
                  class="formbold-form-input"
              />
              <label for="obj22" class="formbold-form-label">2.2 Propiciar alianzas y acuerdos de colaboración entre los
                investigadores y creadores de UPRA y otras universidades e instituciones.</label>
          </div>
      </div>
      ...
      <div class="formbold-input-flex">
          <div>
              <input
                  ...
                  class="formbold-form-input"
              />
              <label for="obj23" class="formbold-form-label">2.3 Apoyar proyectos de investigación y creación dirigidos a la captación de fondos.</label>
          </div>
          <div>
              <input
                  type="text"
                  ...
                  class="formbold-form-input"
              />
              <label for="obj24" class="formbold-form-label">2.4 Propiciar la investigación estudiantil y las
                actividades de creación estudiantil bajo la mentoría de los profesores.</label>
          </div>
      </div>
      ...
      <div class="formbold-input-flex">
          <div>
              <input
                  ...
                  class="formbold-form-input"
              />
              <label for="obj25" class="formbold-form-label">2.5 Fomentar una cultura de avalúo en la investigación y creación.</label>
          </div>
      </div>
      <!-- Submit button -->
