      ...
      <form id="myForm3_2">
        ...
        <div class="formbold-input-flex">
            <div>
              ...
              />
              <label for="titAct" class="formbold-form-label">Título de la actividad</label>
            </div>
        </div>
             <!-- Breve descripcion -->
        <div class="formbold-input-flex">
          ...
          <div>
            ...
            <option value="option1">Académica </option>
            <option value="option2">Artistica</option>
            <option value="option2">Cultural</option>
            <option value="option2">Deportiva</option>
            <option value="option2">Social</option>
            <option value="option2">Tecnológica</option>
            <option value="option2">Otra</option>
            </select>
            <label for="actType" class="formbold-form-label">Tipo de actividad</label>
        </div>
        </div>
