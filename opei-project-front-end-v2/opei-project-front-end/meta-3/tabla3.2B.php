...
<html lang="en">
  <head>
    ...
    <title>UPRA Reports Tabla 3-2 B</title>
</head>
<body>
        <header>
            <h1 class="uprareports">UPRA Reports</h1>
            <h2 class="bienvenidosusuario"><?php echo $department['DepartmentName'] ?></h2>
            <h2 class="tablaheader">Tabla 3.2 B: Empleabilidad de los Egresados</h2>
            <h2 class="tablaheader"> Llenar Informaci&oacute;n en la Tabla 3.2 B</h2>
        </header>
  <body>
      ...
      <form id="myForm3_2b">
        <div class="formbold-input-flex">
            <div>
              ...
              />
              <label for="nameStud" class="formbold-form-label">Nombre del Estudiante</label>
            </div>
            <div>
                <input
                  type="text"
                  ...
                  class="formbold-form-input"
                />
                <label for="progAcadem" class="formbold-form-label">Programa académico del cual se graduó</label>
              </div>
        </div>
              ...
              <div class="formbold-input-flex">
                <div>
                  <input
                    ...
                    class="formbold-form-input"
                  />
                  <label for="lugarEmpleo" class="formbold-form-label">Lugar de Empleo</label>
                </div>
                <div>
                    <input
                      type="text"
                      ...
                      class="formbold-form-input"
                    />
                    <label for="gradYear" class="formbold-form-label">Año de Graduación</label>
                  </div>
