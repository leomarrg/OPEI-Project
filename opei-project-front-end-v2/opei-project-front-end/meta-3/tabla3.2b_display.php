...
<body>
        <header>
            ...
            <h2 class="tablaheader"> Editar Informaci&oacute;n en la Tabla 3.2 B</h2>
        </header>
...
<div class="formbold-main-wrapper-edit">
    <div class="formbold-form-wrapper-edit">
        <table class="table">
          ...
          <tbody>
            <?php
                ...
                $sql = "SELECT * FROM table32b WHERE DepartmentID = ? AND year = ?";
            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<td style='display: none;'>" . $row['table32bID'] . "</td>";
                ...
                echo "<td><a class='delete-btn' href='../meta-3/tabla3.2b_delete.php?id=" . $row['table32bID'] . "'>Borrar</a></td>";
                echo "</tr>";
            }
            // Close connection
            $conn->close();
        ?>
          ...
          <a class="underline-button" href="tabla3.2B.php">Volver</a>
      </div>
    </div>
  </div>
