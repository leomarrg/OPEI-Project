...
<html lang="en">
    <head>
        ...
        <title>UPRA Reports Tabla 3-3</title>
    </head>
<body>
        <header>
            <h1 class="uprareports">UPRA Reports</h1>
            <h2 class="bienvenidosusuario"><?php echo $department['DepartmentName'] ?></h2>
            <h2 class="tablaheader">Tabla 3.3: Otros logros alcanzados por Objetivo y Actividad en la Meta 3</h2>
            <h2 class="tablaheader"> Llenar Informaci&oacute;n en la Tabla 3.3</h2>
        </header>
  ...
  <div class="formbold-form-wrapper">
      ...
      <div class="formbold-input-flex">
          <div>
              ...
              />
              <label for="obj3_1" class="formbold-form-label">3.1 Optimizar y diversificar los servicios a los estudiantes atemperándolos a sus necesidades</label>
          </div>
          <div>
              <input
                  type="text"
                  ...
                  class="formbold-form-input"
              />
              <label for="obj3_2" class="formbold-form-label">3.2 Diversificar las actividades de promoción y reclutamiento<br><br></label>
          </div>
      </div>
      ...
      <div class="formbold-input-flex">
          <div>
              <input
                  ...
                  class="formbold-form-input"
              />
              <label for="obj3_3" class="formbold-form-label">3.3 Facilitar el desarrollo integral de los estudiantes para alcanzar sus metas académicas y profesionales<br><br></label>
          </div>
          <div>
              <input
                  type="text"
                  ...
                  class="formbold-form-input"
              />
              <label for="obj3_4" class="formbold-form-label">3.4 Instituir los vínculos con los egresados para lograr una mayor colaboración y participación en diversas iniciativas institucionales</label>
          </div>
      </div>
      ...
      <div class="formbold-input-flex">
          <div>
              <input
                  ...
                  class="formbold-form-input"
              />
              <label for="obj3_5" class="formbold-form-label">3.5 Fortalecer la cultura de avalúo orientada a mejorar los servicios a los estudiantes</label>
          </div>
      </div>                                
      <div class="formbold-input-flex">
      </div>
      ...
      <a class="underline-button" href="tabla3.3_display.php">Editar</a>
    </form>
  </div>
</div>
