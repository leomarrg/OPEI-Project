...
<div class="formbold-main-wrapper">
    <div class="formbold-form-wrapper">
      <form id="myForm4_1">
      <h4 class="header1"> Llenar Informaci&oacute;n<br>  <br>Tabla 4.1: Actividades dirigidas a la comunidad externa</h4>
        ...
        <div class="formbold-input-flex">
            ...
            <div>
                <input
                  ...
                  class="formbold-form-input"
                />
                <label for="coordinadorAct" class="formbold-form-label">Coordinador de la Actividad</label>
              </div>
        </div>
        ...
        <div class="formbold-input-flex">
            <div>
                <input
                  ...
                  class="formbold-form-input"
                />
                <label for="numPart" class="formbold-form-label">Número de participantes</label>
              </div>
        </div>
        <!-- Submit button -->
        <button class="formbold-btn">Submit</button>
        <a class="underline-button" href="tabla4.1_display.php">Editar</a>
      </form>
    </div>
  </div>
