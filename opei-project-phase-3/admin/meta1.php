...
<head>
    ...
    <title>UPRA Annual Report</title>
...
<body>
    <header>
      ...
      <a href='website.php' class="backmainmenu" ><h1>UPRA Annual Report</h1></a>
...
// Function to update a row in the table12 table
function updateRow12($id, $field1, $field2, $field3, $field4, $field5, $field6, $field7, $field8, $field9, $field10, $field11, $field12, $field13, $field14, $field15, $field16, $field17, $field18) {
  global $conn;
  $sql = "UPDATE table12 SET field1=?, field2=?, field3=?, field4=?, field5=?, field6=?, field7=?, field8=?, field9=?, field10=?, field11=?, field12=?, field13=?, field14=?, field15=?, field16=?, field17=?, field18=? WHERE table12ID=?";
  $stmt = $conn->prepare($sql);
  $stmt->bind_param("ssssssssssssssssssi", $field1, $field2, $field3, $field4, $field5, $field6, $field7, $field8, $field9, $field10, $field11, $field12, $field13, $field14, $field15, $field16, $field17, $field18,  $id);
  $stmt->execute();
  $stmt->close();
}
...
// Check if the salvar button was clicked
if (isset($_POST['action12']) && $_POST['action12'] == 'salvar' && isset($_POST['table12ID'])) {
  $id = $_POST['table12ID'];
  $field1 = $_POST['field1'];
  $field2 = $_POST['field2'];
  $field3 = $_POST['field3'];
  ...
  updateRow12($id, $field1, $field2, $field3, $field4, $field5, $field6, $field7, $field8, $field9, $field10, $field11, $field12, $field13, $field14, $field15, $field16, $field17, $field18);
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        <tr>
            <form method='post'>
                ...
                <td><input type='text' name='field1' value='<?php echo "".$row["field1"]."";  ?>' class='editable' readonly></td>
                <td><input type='text' name='field2' value='<?php  echo "".$row["field2"]."";  ?>' class='editable' readonly></td>
                <td><input type='text' name='field3' value='<?php  echo "".$row["field3"]."";  ?>' class='editable' readonly></td>
                <td><input type='text' name='field4' value='<?php  echo "".$row["field4"]."";  ?>' class='editable' readonly></td>
                <td><input type='text' name='field5' value='<?php  echo "".$row["field5"]."";  ?>' class='editable' readonly></td>
                <td><input type='text' name='field6' value='<?php  echo "".$row["field6"]."";  ?>' class='editable' readonly></td>
                <td><input type='text' name='field7' value='<?php  echo "".$row["field7"]."";  ?>' class='editable' readonly></td>
                <td><input type='text' name='field8' value='<?php  echo "".$row["field8"]."";  ?>' class='editable' readonly></td>
                <td><input type='text' name='field9' value='<?php  echo "".$row["field9"]."";  ?>' class='editable' readonly></td>
                <td><input type='text' name='field10' value='<?php  echo "".$row["field10"]."";  ?>' class='editable' readonly></td>
                <td><input type='text' name='field11' value='<?php  echo "".$row["field11"]."";  ?>' class='editable' readonly></td>
                <td><input type='text' name='field12' value='<?php  echo "".$row["field12"]."";  ?>' class='editable' readonly></td>
                <td><input type='text' name='field13' value='<?php  echo "".$row["field13"]."";  ?>' class='editable' readonly></td>
                <td><input type='text' name='field14' value='<?php  echo "".$row["field14"]."";  ?>' class='editable' readonly></td>
                <td><input type='text' name='field15' value='<?php  echo "".$row["field15"]."";  ?>' class='editable' readonly></td>
                <td><input type='text' name='field16' value='<?php  echo "".$row["field16"]."";?>' class='editable' readonly></td>
                <td><input type='text' name='field17' value='<?php  echo "".$row["field17"]."";  ?>' class='editable' readonly></td>
                <td><input type='text' name='field18' value='<?php  echo "".$row["field18"]."";  ?>' class='editable' readonly></td>
                <td class='editar-column'><a href='#' class='editar-btn' onclick='makeEditable(event)'>Editar</a></td>
                <td class='borrar-column'><a href='<?php echo "?action12=delete&id12=" . $row["table12ID"] . "&department=$department&year=$year"; ?>' class='borrar-btn'>Borrar</a></td>
...
?>
  ...
  if (isset($_POST['action15']) && $_POST['action15'] == 'salvar' && isset($_POST['id15'])) {
    ...
    <div class="footer-box">
        ...
        <p>&copy; 2024 UPRA Annual Report. All rights reserved.</p>
    </div>
