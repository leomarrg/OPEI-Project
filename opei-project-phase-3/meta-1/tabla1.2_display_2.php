...
<div class="formbold-main-wrapper-edit">
    ...
    <h4 class="header1">Editar Informaci&oacute;n<br>  <br>Tabla 1.2: Programas acreditados</h4>
        ...
        <?php
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><p class='header1'>Communicarse con OPEI para editar esta tabla</p></td>";
