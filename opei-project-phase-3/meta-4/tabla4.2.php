      ...
      <h4 class="header1"> Llenar Informaci&oacute;n<br>  <br>Tabla 4.2: Cursos ofrecidos a la comunidad externa</h4>
        ...
        <div class="formbold-input-flex">
          <div>
            ...
            />
            <label for="titCurso" class="formbold-form-label">Título del curso</label>
          </div>
          
        </div>
        <div class="formbold-input-flex">
          <label class="formbold-form-label">Número de estudiantes matriculados en cursos o programas en Educación Continua</label>
        </div>
        ...
        <div class="formbold-input-flex">
          <!-- Breve descripcion -->
            ...
            <div>
                <input
                  type="text"
                  name="eduContinuaPrimerSemes"
                  id="eduContinuaPrimerSemes"
                  placeholder="Escriba texto..."
                  class="formbold-form-input"
                />
                <label for="eduContinuaPrimerSemes" class="formbold-form-label">Primer Semestre</label>
              </div>
              <div>
                <input
                  type="text"
                  name="eduContinuaSegSemes"
                  id="eduContinuaSegSemes"
                  placeholder="Escriba texto..."
                  class="formbold-form-input"
                />
                <label for="eduContinuaSegSemes" class="formbold-form-label">Segundo Semestre</label>
              </div>

        </div>
        <div class="formbold-input-flex">
          <label class="formbold-form-label">Número de estudiantes matriculados en cursos o programas en Cerfificaciones Profesionales</label>
        </div>
                <!-- Breve descripcion -->
                <div class="formbold-input-flex">
                  <!-- Breve descripcion -->
                    ...
                    <div>
                        <input
                          type="text"
                          name="certProfPrimerSemes"
                          id="certProfPrimerSemes"
                          placeholder="Escriba texto..."
                          class="formbold-form-input"
                        />
                        <label for="certProfPrimerSemes" class="formbold-form-label">Primer Semestre</label>
                      </div>
                      <div>
                        <input
                          type="text"
                          name="certProfSegSemes"
                          id="certProfSegSemes"
                          placeholder="Escriba texto..."
                          class="formbold-form-input"
                        />
                        <label for="certProfSegSemes" class="formbold-form-label">Segundo Semestre</label>
                      </div>
        ...
        <a class="underline-button" href="tabla4.2_display.php">Editar</a>
      </form>
    </div>
  </div>
