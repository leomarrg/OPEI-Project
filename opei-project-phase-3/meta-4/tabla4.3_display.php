...
<div class="formbold-main-wrapper-edit">
  ...
  <h4 class="header1">Editar Informaci&oacute;n<br>  <br>Tabla 4.3: Otros logros alcanzados por Objetivo y Actividad en la Meta 4</h4>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        $sql = "SELECT * FROM table43 WHERE DepartmentID = ? AND year = ?";
        ...
        while ($row = $result->fetch_assoc()) {
            echo "<tr>";
            echo "<td style='display: none;'>" . $row['table43ID'] . "</td>";
            ...
            echo "<td><a class='delete-btn' href='../meta-4/tabla4.3_delete.php?id=" . $row['table43ID'] . "'>Borrar</a></td>";
            echo "</tr>";
        }
        // Close connection
        $conn->close();
    ?>
      ...
      <div class="formbold-main-wrapperDept">
        <a class="underline-button" href="tabla4.3.php">Volver</a>
    </div>
  </div>
</div>
