...
<html lang="en">
  <head>
    ...
    <title>UPRA Reports Tabla 5-1 Editar</title>
...
<div class="formbold-main-wrapper-edit">
    ...
    <h4 class="header1">Editar Informaci&oacute;n<br>  <br>Tabla 5.1:  Actividades de adiestramiento y readiestramiento ofrecidas por su Departamento a la Facultad</h4>
        ...
        <table class="table">
            ...
            <tbody>
              ...
              $sql = "SELECT * FROM table51 WHERE DepartmentID = ? AND year = ?";
              ...
              while ($row = $result->fetch_assoc()) {
                  echo "<tr>";
                  echo "<td style='display: none;'>" . $row['table51ID'] . "</td>";
                  ...
                  echo "<td><a class='delete-btn' href='../meta-5/tabla5.1_delete.php?id=" . $row['table51ID'] . "'>Borrar</a></td>";
                  echo "</tr>";
          ...
          <a class="underline-button" href="tabla5.1.php">Volver</a>
      </div>
    </div>
  </div>
