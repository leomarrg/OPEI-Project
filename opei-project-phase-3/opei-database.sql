...
(21, 1, 2024, 'CCOM4095', 'Activación', 'Aprobado', 'Proyecto Final');
...
(21, 1, 2024, 'Valor para cambio academico', 'Valor Academico Institucional', 'Valor Cambio Academico', 'Valor Cambio Sustancial');
...
(41, 1, 2024, '2', '7', '5', '18', '14', '11', '10', '10', '12', '1', '9', '16', '40', '36', '41', '56', '15', '58');
...
(33, 1, 2024, 'CCOM3001', 'Agencia que acredito el programa', '2023', '2024', '4', 'Recomendación');
...
(10, 1, 2024, 'CCOM4065', 'Estrategia', 'Indicador', 'Resultados', 'Acciones que son correctivas');
...
(8, 1, 2024, '1.1 Reviews', '1.2 Reviews', '1.3 Review', '1.4 Reviews', '1.5 Reviews', '1.6 Reviews');
...
(23, 1, 2024, 'Insertar Profesor', 'Actividad', '18-05-2024', 'No', 'Artículo Publicado Revista Arbitrada', 'No arbritada', 'No', 'Entidad');
...
(14, 1, 2024, 'Artístico', '10', 'Reconocimientos descriptivos', '2024-05-17', 'El organismo');
...
(11, 1, 2024, 'Estudiante', 'CCOM', 'Algun lugar', '2024', 'Si', 'Comentado');
...
(8, 1, 2024, 'Review 3.1', 'Review 3.2', 'Review 3.3', 'Review 3.4', 'Review 3.5');
...
--
ALTER TABLE `table11a`
  MODIFY `table11aID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `table12`
  MODIFY `table12ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `table15`
  MODIFY `table15ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
